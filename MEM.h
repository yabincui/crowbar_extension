...
void MEM_check_all_blocks_func(MEM_Controller controller,
                               char *filename, int line);
void MEM_check_all_blocks_empty_func(MEM_Controller controller,
								char *filename, int line);
...
#define MEM_malloc_debug(size, file, line)\
  (MEM_malloc_func(MEM_CURRENT_CONTROLLER,\
                   file, line, size))
...
#define MEM_check_all_blocks_empty()\
  (MEM_check_all_blocks_empty_func(MEM_CURRENT_CONTROLLER, __FILE__, __LINE__))

#else /* DEBUG */
#define MEM_dump_blocks(fp) ((void)0)
#define MEM_check_block(p)  ((void)0)
#define MEM_check_all_blocks() ((void)0)
#define MEM_check_all_blocks_empty() ((void)0)
